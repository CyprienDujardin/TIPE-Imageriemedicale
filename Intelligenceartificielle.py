#L'algorithme n'est pas terminé il sera mis en ligne fois complété, ci dessous le protocole en suivant la méthode de backpropagation pour une classification
...
#on définit un nombre de réseau 
...
#on définit aléatoirement les poids (entre -1 et 1)(Tableu de dimention des données)
 ...
 #on entraine le modèle 
    ...
    #on applique le correction sur les poids
